...
// Consultar eventos inscritos por email
...
<template>
    <div class="min-h-screen bg-gray-950 text-white">
        ...
        <!-- Modal de inscripciones a eventos-->
        ...
        <!-- Modal para ver las inscripciones hechas -->
            ...
            <div class="space-y-5">
                ...
                <div v-if="eventosDelUsuario.length > 0" class="space-y-3">
                    <div v-for="evento in eventosDelUsuario" :key="evento.id" class="bg-gray-800 rounded-lg p-3">
                        <p class="font-bold text-purple-400">{{ evento.titulo }}</p>
